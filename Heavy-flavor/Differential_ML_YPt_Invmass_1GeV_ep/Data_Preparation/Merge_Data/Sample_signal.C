...
void Sample_signal(double ymin = -1.0, double ymax = 1.0, double ptmin = 1.0, double ptmax = 2.0){
...
Int_t nexpected_D0 = hexp_D0Signal->GetBinContent(binX,binY); 
...
// Simulated events correspind 1.747e+9; but we need to 10fb^-1 = 4.72162e+9 
Int_t nexpected_D0 = (4.72162e+9/1.747e+9)*h0_D0Sample->GetEntries(); 
