...
cd ../
root -b -l -q draw_expected_Signal_pt_y.C
cd Merge_Data/
...
root -b -l -q Sample_signal.C'('${y_arr[i]}','${y_arr[i+1]}','${pt_arr[j]}','${pt_arr[j+1]}')'
root -b -l -q Sample_bkg.C'('${y_arr[i]}','${y_arr[i+1]}','${pt_arr[j]}','${pt_arr[j+1]}')'
