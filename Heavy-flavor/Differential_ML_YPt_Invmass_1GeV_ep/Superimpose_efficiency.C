...
void Superimpose_efficiency(float ymin = -1.0, float ymax = 1.0, float ptmin=1.0, float ptmax = 2.0){
 ...
 TMultiGraph *mg = new TMultiGraph("mg",";BDT Threshold; Efficiencies");
   ...
   TGraph *greff_bkg = new TGraph(Form("./ML_Output_Optuna_%1.1f_%1.1f_%1.1f_%1.1f/bdt_efficiency_bkg_vs_threshold.txt",ymin,ymax,ptmin,ptmax),"%lg %lg");
    ...
    leg->DrawClone("Same");
    c->SaveAs(Form("./ML_Output_Optuna_%1.1f_%1.1f_%1.1f_%1.1f/BDT_efficiencies_plot_graph_%1.1f_%1.1f_%1.1f_%1.1f.png",ymin,ymax,ptmin,ptmax,ymin,ymax,ptmin,ptmax));
    c->SaveAs(Form("./ML_Output_Optuna_%1.1f_%1.1f_%1.1f_%1.1f/BDT_efficiencies_plot_graph_%1.1f_%1.1f_%1.1f_%1.1f.root",ymin,ymax,ptmin,ptmax,ymin,ymax,ptmin,ptmax));
